    ...
    public class WindowsFactory : IWindowsFactory
    {
        ...
        public WindowsFactory(IUIRootFactory uiFactory, IPrefabLoader prefabLoader, DiContainer container)
        {
            ...
            _windows = new Dictionary<WindowType, WindowBase>()
            {
                ...
                { WindowType.SelectHeroSlot, prefabLoader.LoadPrefab<SelectHeroSlotWindow>(WindowPaths.SelectActiveHeroSlot) }
            };
        }
        ...
        public WindowBase CreateWindow<TPayload>(WindowType window, int windowOrder, TPayload payload, Action onClosing = null)
        {
